...
<html lang="en">
    <head>
        ...
        <title>Charity.in | Detail Penerima Donasi</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="<?= BASEURL; ?>/img/favicon.ico" />
        <!-- Bootstrap icons-->
        <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css" rel="stylesheet" />
        <!-- Core theme CSS (includes Bootstrap)-->
        <link href="<?= BASEURL; ?>/css/detail_penerima_donasi.css" rel="stylesheet" />
    </head>
    <body>
        <!-- Navigation-->
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fs-5 mb-5">
                            Terakhir menempuh pendidikan pada tingkat <?= $data['penerima_donasi']['pendidikan']; ?>
                        </div>
                        <table>
                            <tr>
                                <td style="width: 150px;">Usia</td>
                                <td>:</td>
                                <td><?= $data['penerima_donasi']['usia']; ?></td>
                            </tr>
                            <tr>
                                <td>Jenis Kelamin</td>
                                <td>:</td>
                                <td><?= $data['penerima_donasi']['gender']; ?></td>
                            </tr>
                            <tr>
                                <td>Kota Asal</td>
                                <td>:</td>
                                <td><?= $data['penerima_donasi']['asal']; ?></td>
                            </tr>
                            <tr>
                                <td>Status Donasi</td>
                                <td>:</td>
                                <td><?= $data['penerima_donasi']['status']; ?></td>
                            </tr>
                        </table>
                        <br>
        ...
        <!-- Core theme JS-->
        <script src="<?= BASEURL; ?>/js/detail_penerima_donasi.js"></script>
    </body>
</html>
